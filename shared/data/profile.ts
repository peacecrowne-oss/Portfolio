...
export const PROFILE: Profile = {
  ...
  about: {
    intro: [
      "Business Intelligence Developer | Data Analyst with over 5 years of experience transforming complex datasets into clear, actionable dashboards and reports that drive real business decisions.",
      "My technical expertise includes Power BI (DAX and Power Query), SQL and Microsoft Fabric with hands-on experience developing semantic models, Dataflows Gen2, and Direct Lake solutions, as well as managing Fabric workspaces, deployment pipelines, scheduled refreshes, Row-Level Security (RLS), and Power BI Apps to deliver scalable, secure, and high-performance BI solutions.",
      "Outside of data I explore AI and automation to build smarter, more innovative data solutions.",
    ],
    background: {
      journey:
    ...
    coreStrengths: [
      ...
      { name: "Excel", level: "Advanced", percent: 90 },
      { name: "ETL", level: "Advanced", percent: 90 },
      { name: "Python", level: "Intermediate", percent: 70 },
      { name: "Microsoft Fabric", level: "Advanced", percent: 85 },
      { name: "Azure", level: "Intermediate", percent: 70 },
    ],
  },
};
